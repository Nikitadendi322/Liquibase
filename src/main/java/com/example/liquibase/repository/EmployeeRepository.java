...
import com.example.liquibase.dto.ReportDto;
...
public interface EmployeeRepository extends JpaRepository<Employee, Integer> {
    ...
    @Query("SELECT new ru.skypro.lessons.liquidbase.ReportDto(e.position.position,count(e.id),max (e.salary),min (e.salary),avg (e.salary), FROM Employee e GROUP BY e.position.position")
